<# 
.SYNOPSIS
自动为 FlowGet 程序添加端口URL ACL权限，自动提权
请使用powershell执行此脚本
#>
...
Write-Host "正在为FlowGet程序添加端口 $TARGET_PORT 访问权限..." -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host "`n"
...
netsh advfirewall firewall add rule name="FlowGet_$TARGET_PORT" `
