...
namespace FlowGet.ViewModels.Downloads
{
    ...
    public partial class DownloadViewModel
    {
        protected class DownloadProgress(DownloadViewModel downloadViewModel) : IDialogProgress
        {
            ...
            private void OnTimedEvent(Object? source, ElapsedEventArgs e)
            {
                ...
                long rate = tmpBytes - _lastBytes;
                _lastBytes = tmpBytes;

                double progress = _isIncProgressNum ? _currentProgress++ : _currentProgress;

                Dispatcher.UIThread.Post(() =>
                {
                    downloadViewModel.DownloadRateBytes = rate;
                    downloadViewModel.ProgressNum = progress;
                });
            }
